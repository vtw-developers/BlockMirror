...
makeTurtleBlock("done", false, [], "sttart the turtle loop ", ["mainloop"]);
makeTurtleBlock("namee", false, [], "do smth turtle ", [""]);
...
TOOLBOX_CATEGORY.TURTLES = {
  name: "Turtles",
  colour: "PLOTTING",
  blocks: ["turtle.mainloop()", "turtle.namee('name')", "turtle.forward(50)", "turtle.backward(50)", "turtle.right(90)", "turtle.left(90)", "turtle.goto(0, 0)", "turtle.setx(100)", "turtle.sety(100)", "turtle.setheading(270)", "turtle.pendown()", "turtle.penup()", "turtle.pencolor('blue')"]
};
...
BlockMirrorTextToBlocks.BLOCKS.push({
  "type": "ast_For",
  "message0": "for each iitem %1 in list %2 : %3 %4",
  "args0": [{
    "type": "input_value",
    "name": "TARGET"
  }, {
...
// translate block into python code
...
// translate python code back to blockly block
